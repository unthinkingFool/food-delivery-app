...
/* Matches Register.jsx / Login.jsx / ForgetPassword.jsx               */
/* ------------------------------------------------------------------ */
const INK = "#17213A";
const NAVY = "#14213D";
const CREAM = "#FFF6E4";
...
const ScallopEdge = () => (
  ...
  >
    ...
    <rect width="100%" height="100%" fill="url(#kd-scallop-otp)" />
  </svg>
);
...
const VerifyOTP = () => {
  ...
  const handleVerifyOTP = async (e) => {
    ...
    try {
      const response = await fetch(
        `http://localhost:3000/api/auth/verify-otp/${role}`,
        {
          method: "POST",
  ...
  return (
    ...
    >
      ...
      <BrandPanel
        tagline="Almost there — confirm it's you."
      ...
      <main className="flex flex-1 justify-center overflow-y-auto px-6 py-6 sm:px-10 lg:h-screen lg:py-8">
        <div className="my-auto w-full max-w-md">
          ...
          <div
            className="mt-3 mb-5 rounded-xl border px-4 py-3"
          ...
          <form onSubmit={handleVerifyOTP} className="space-y-4">
            <div>
              ...
              <input
                ...
                maxLength={6}
                required
                className="w-full rounded-xl border-2 border-[#EADFC8] bg-white px-4 py-3 text-center text-xl tracking-[0.5em] text-[#17213A] outline-none transition focus:border-[#E63182] focus:ring-4 focus:ring-[#E63182]/15"
              />
            </div>
            ...
            <button
              ...
              style={{
                backgroundColor:
                  loading || otp.length !== 6 ? "#F4B74099" : MUSTARD,
                color: NAVY,
              }}
              onMouseEnter={(e) => {
